...
#Region "New"
  Public Sub New(ByVal _Sistema As Sistema, ByVal _Restriccion As Restriccion, Optional ByVal _OpcionNuevo As Integer = 0)
  ...
  Public Sub New(ByVal _Sistema As Sistema, ByVal _OpcionActual As Integer, Optional ByVal _OpcionNuevo As Integer = 0)
