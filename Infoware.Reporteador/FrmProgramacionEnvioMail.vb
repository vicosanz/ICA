...
#Region "New"
  ...
  Public Sub New(ByVal _Sistema As Sistema, ByVal _Restriccion As Restriccion, ByVal _Reporte As Reporte, Optional ByVal _OpcionNuevo As Integer = 0)
    ...
    FrmProgramacionEnvioMail_AplicarRestricciones(Me, Nothing)
  End Sub

  Public Sub New(ByVal _Sistema As Sistema, ByVal _OpcionActual As Integer, ByVal _Reporte As Reporte, Optional ByVal _OpcionNuevo As Integer = 0)
    Me.New(_Sistema, _Sistema.Restricciones.Buscar(_OpcionActual), _Reporte, _OpcionNuevo)
  End Sub
...
#End Region
  ...
  Private Sub btnbuscarcorreos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnbuscarcorreos.Click
    Dim f As New FrmListaContactos(Sistema, Restriccion, mReporte, mCorreos, True)
    f.ShowDialog()
