...
#Region "Eventos"
  ...
  Private Sub FrmListaContactos_Imprimir(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Imprimir
    'imprimir
  End Sub
#End Region
...
#Region "New"
  ...
  Public Sub New(ByVal _Sistema As Sistema, ByVal _Restriccion As Restriccion, ByVal _Reporte As Reporte, ByVal _Correos As CorreosElectronicos, ByVal _busqueda As Boolean)
    MyBase.New(_Sistema, _Restriccion, _busqueda)
