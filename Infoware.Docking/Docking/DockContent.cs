...
namespace Infoware.Docking
{
	public class DockContent : Form, IDockContent
	{
        ...
        [LocalizedCategory("Category_Docking")]
        [LocalizedDescription("DockContent_FullScreen_Description")]
        [DefaultValue(false)]
        public bool FullScreen
        {
            get { return mFullScreen; }
            set { mFullScreen = value; }
        }
    ...
    [Browsable(false)]
    public DockState DockStateBackup
    {
      get { return DockHandler.DockStateBackup; }
      set { DockHandler.DockStateBackup = value; }
    }
    ...
    public void Ocultar()
    {
      DockStateBackup = DockHandler.IsHidden ? DockState.Unknown : DockHandler.VisibleState;
      if (!DockHandler.IsHidden)
      {
        switch (DockHandler.VisibleState)
        {
          ...
          case DockState.DockRight:
            ...
            break;
          default:
            DockStateBackup = DockState.Unknown;
            break;
        }
      }
    }
    ...
    {
      if (DockStateBackup != DockState.Unknown)
      {
        this.DockState = DockStateBackup;
        DockStateBackup = DockState.Unknown;
      }
    }
